      ...
      <div className={`flex-1 overflow-y-auto px-4 pt-4 ${NAV_PB}`}>
        <div className="flex justify-between gap-4">
          {payment.logo ? (
            ...
            <span className="font-display text-lg font-bold">Bang On</span>
          )}
        ...
        <p className="mt-8 font-body text-xs text-black/40">Generated by Bang On</p>
      </div>
          ...
          <>
            ...
            {doc.type === 'invoice' && onMarkPaid && (
              <button
                type="button"
                onClick={onMarkPaid}
                className="min-h-[48px] w-full rounded-xl border border-black/20 font-body text-sm"
              >
                Mark as paid
              </button>
            )}
